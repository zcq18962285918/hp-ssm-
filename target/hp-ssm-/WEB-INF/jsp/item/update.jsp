...
<link rel="stylesheet" type="text/css"
	href="${ctx}/resource/css/common.css" />
<link rel="stylesheet" type="text/css"
		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="">首页</a><span class="crumb-step">&gt;</span>
				</div>
			</div>
							...
							<tbody>
								...
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="name" size="50" value="${obj.name }" type="text">
									</td>
								</tr>
								...
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="price" size="50" value="${obj.price }" type="text">
									</td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>商品数量：</th>
									<td><input class="common-text required" id="title"
										name="kc" size="50" value="${obj.kc }" type="text">
									</td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>商品折扣：</th>
									<td><input class="common-text required" id="title"
										name="zk" size="50" value="${obj.zk}" type="text"></td>
								</tr>
								<tr>
									<th width="120"><i class="require-red">*</i>商品类别：</th>
									<td><select name="categoryIdTwo" id="catid"
										class="required">

											<c:forEach items="${types}" var="data" varStatus="l">
												<option value="${data.id}"
													${obj.categoryIdTwo == data.id ? "selected" : ""}>${data.name}</option>
											</c:forEach>
									</select></td>
								</tr>
								...
								<tr>
									...
									<td>
									<img src="${obj.url1}" alt="没有图片" style="width: 100px;height: 100px">
									<input name="file" id="" type="file" ></td>
								</tr>

								<tr>
									<th><i class="require-red">*</i>副图1：</th>
									<td>
									<img src="${obj.url2}" alt="没有图片" style="width: 100px;height: 100px">
									<input name="file" id="" type="file"></td>
								</tr>
								...
								<tr>
									...
									<td>
									<img src="${obj.url3}" alt="没有图片" style="width: 100px;height: 100px">
									<input name="file" id="" type="file"></td>
								</tr>
								...
								<tr>
									...
									<td>
									<img src="${obj.url4}" alt="没有图片" style="width: 100px;height: 100px">
									<input name="file" id="" type="file"></td>
								</tr>

								<tr>
									<th><i class="require-red">*</i>副图4：</th>
									<td><c:if test="${obj.url5}!=null"/>
									<img src="${obj.url5}" style="width: 100px;height: 100px">
									<input name="file" id="" type="file"></td>
								</tr>
								...
								<tr style="padding-top: 30px">
									<th>描述：</th>
									<td>
										<!-- 加载编辑器的容器 --> <script id="remark_txt_1" name="ms"
											type="text/plain" style="width:100%;height:300px;">${obj.ms}</script>
