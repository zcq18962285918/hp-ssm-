        ...
        <div id="vipRight">
            <div style="width:938px;border:1px solid #ddd;background:#fff;">
                ...
                <div class="width100 hidden_yh"
                     style="height:74px;line-height:74px;background:#f5f8fa;border-bottom:1px solid #ddd;" id="navLt">
                                    ...
                                    <div class="right_yh">
                                        <c:if test="${data.status == 3}">
                                            <a href="${ctx}/itemOrder/pj?id=${chil.itemId}"
                                               ...
                                               style="margin-top:10px;padding:6px;">去评价</a>
                                        </c:if>
                                    </div>
                                </div>
                            </c:forEach>
                            ...
                            <div style="width:838px;padding-top:30px;padding-bottom:30px;"
                                ...
                                <c:if test="${data.status == 0}">
                                    <a href="${ctx}/itemOrder/qx?id=${data.id}"
                                       class="c_33 onHover font20 onorange right_yh" style="margin-top:">取消订单</a>
                                </c:if>
                                ...
                                <c:if test="${data.status == 2}">
                                    <a href="${ctx}/itemOrder/sh?id=${data.id}"
                                       class="c_33 onHover font20 onorange right_yh" style="margin-top:">去收货</a>
                                </c:if>
                                <c:if test="${data.status == 3}">
                                    <a href="#" class="c_33 onHover font20 onorange right_yh"
                                    ...
                                    <div class="right_yh">
                                        ...
                                        <c:if test="${data.status == 3}">
                                           ...
                                           ${chil.status}
                                            ...
                                            <c:if test="${chil.status == 1}">
                                                <a href="#"
                                                   class="onfff block_yh tcenter font16 onHoverr"
                                                   style="margin-top:10px;padding:6px;">退货中</a>
                                            </c:if>
                                            <c:if test="${chil.status == 2}">
                                                <a href="#"
                                                   class="onfff block_yh tcenter font16 onHoverr"
                                                   style="margin-top:10px;padding:6px;">退货成功</a>
                                            </c:if>
                                        </c:if>
