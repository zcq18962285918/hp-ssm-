		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="">首页</a>
				</div>
			</div>
					...
					<form action="${ctx}/item/findBySql" method="post">
						<table class="search-tab">
                            ...
                            <td>
								...
								<th width="70">关键字:</th>
								<td><input class="common-text" placeholder="商品名称"
									name="name" value="${obj.name}" id="" type="text"></td>
					...
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<c:forEach items="${pagers.datas}" var="data" varStatus="l">
								<tr>
									<td>${data.name}</td>
									<td><img alt="" src="${data.url1}"
										style="width: 100px; height: 100px"></td>
									<td>${data.price}</td>
									<c:if test="${data.zk eq null}">
										<td>暂无折扣</td>
									</c:if>
									...
									<td><a class="link-update"
										href="${ctx}/item/update?id=${data.id}">修改</a> <a
										class="link-del" href="${ctx}/item/delete?id=${data.id}">下架</a>
									</td>
								</tr>
							</c:forEach>
							...
							<tr>
								<td colspan="8">
									<div class="pagelist">
										<!-- 分页开始 -->
										<pg:pager url="${ctx}/item/findBySql" maxIndexPages="5"
