...
<div class="width1198 center_yh" style="height:35px;background:#f0f0f0;border:1px solid #ddd;margin-top:25px;">
    ...
    <a href="${ctx}/item/shoplist?price=1&categoryIdTwo=${obj.categoryIdTwo}" class="mR">价格<img
            src="${ctx}/resource/user/images/gg.png"></a>
    <a href="${ctx}/item/shoplist?gmNum=1&categoryIdTwo=${obj.categoryIdTwo}" class="mR">销量<img
            src="${ctx}/resource/user/images/gg.png"></a>
    <script>
        $(".mR").click(function () {
